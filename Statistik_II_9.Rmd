...
* Gruppenverglieche sind  **unabhängig** voneinander
...
In der angewandte Statistik sind 2 Arten von Modellen gängig:
...
* 2 Gruppen mit $n=5$: G1 erhält Training, G2 lediglich Zuwendung
...
Die Quadratsumme $(QS)$ entspricht der quadrierten Abweichung der Mittelwerte $(\bar{Gruppe_{i}})$ vom Gesamtmittelwert $(\bar{G})$ multipliziert mit der Zellgröße $n$ und der Anzahl der Stufen der Gruppenvariable:
...
Die Quadratsumme $(QS)$ entspricht der quadrierten Abweichung der Mittelwerte $(\bar{Zeit_{j}})$ vom Gesamtmittelwert $(\bar{G})$ multipliziert mit der Zellgröße $n$ und der Anzahl der Messwiederholungen:
...
* Ziel: Abbilden der Variabilität der Personen in der Stichprobe
...
* Nur für Messwiederholungsfaktoren mit $\geq2$ Messungen pro Person relevant
