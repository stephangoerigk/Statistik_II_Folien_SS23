...
* Reduzierte Annahmen im Vergleich zu parametrischen Verfahren:
  ...
  * zufällige Zuordnung von Versuchspersonen zu gucken

* Daher: Falls möglich werden parametrische Verfahren bevorzugt (beziehn mehr Informationen ein)
...
* Nonparametrischer Tests setzen in der Regel Ordinalskalenniveau voraus
...
* Wird dem unabhängigen t-Test in folgenden Szenarien vorgezogen
  ...
  * Merkmal ist in der Population nicht normal verteilt (Test der NV auf Basis der Stichprobendaten)
...
* Jede Person erhält basierend auf ihrem Messwert einen Rangplatz
  ...
  * Person mit der niedrigsten Messwert auf der $AV$ erhält Rangplatz 1
  
  * Nächste Person erhält am Platz 2
...
* Frage: Welche Abreichung des empirischen $U$-Werts von $\mu_U$ ist ausreichend für signifikantes Ergebnis?
...
* Nonparametrisches Pendant für anhängigen t-Test

* Nutzt ebenfalls Bildung einer Rangreihe

Vorgehen:

1. Bilden der Differenz zwischen Messwertpaaren (wie bei anhängigem t-Test)
