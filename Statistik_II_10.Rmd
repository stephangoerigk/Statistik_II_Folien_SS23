...
**1. $\chi^2$-Tests**
  ...
  * $H_1:$ "Es gibt Unterschieder in der **Verteilung** der Kategorien."
...
* $\chi^2$ kann aufgrund der Quadrierung in der Formel nur positive Werte annehmen
  ...
  * unspezifischer Test $\rightarrow$ es können keine gerichteten Hypothesen getestet werde
...
* Zur Berechnung müssen wir wissen, wie sich hedes Merkmal alleine verteilen würde (Ignorieren des anderen Merkmals)

* Dies schätzen wir über die sogenannten **Randhäufigkeiten**

* relative Randhäufigkeiten (in %) dienen als Schötzer für die Wahrscheinlichkeit einer Merkmalsstufe in der Population $(p_i$ bzw. $p_j)$
