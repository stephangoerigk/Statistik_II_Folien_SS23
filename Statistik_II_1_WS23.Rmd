...
Termine:
* 14 Termine
* Mittwoch 09:10 - 10:40 (Audimax)

Begleitendes Seminar:
* Mittwoch 12:20-13:05 (SR005, Pavillon 5)
* Dozentin: Sara Vragolic ([sara.vragolic@charlotte-fresenius-uni.de](mailto:sara.vragolic@charlotte-fresenius-uni.de))

Materialien:
* werden auf [Studynet](https://studynet.hs-fresenius.de/ilias.php?ref_id=21955&cmd=view&cmdClass=ilobjgroupgui&cmdNode=xc:o3&baseClass=ilRepositoryGUI) bereitgestellt
...
```{r echo = F}
df = readxl::read_xlsx("Modul Quantitative Methoden II_Termine_WS23.xlsx", sheet = "Tabellenblatt1")[1:13, 1:3]
...
* $p$ ist die Anzahl der vergliichenen Gruppen.
